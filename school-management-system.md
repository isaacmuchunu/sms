# School Management System — Full-Stack Technical Document

> **Technology Stack:** Node.js (Backend) + React (Frontend)  
> **Database:** MongoDB with Mongoose ODM  
> **Target Audience:** Developers, Technical Architects, Development Teams  
...
- [1. Introduction & Project Overview](#1-introduction--project-overview)
  - [1.1 Purpose and Scope](#11-purpose-and-scope)
    ...
    - [1.1.2 Scope Boundaries](#112-scope-boundaries)
    - [1.1.3 Target User Personas](#113-target-user-personas)
  - [1.2 Functional Requirements Overview](#12-functional-requirements-overview)
    - [1.2.1 Core Module Inventory](#121-core-module-inventory)
    - [1.2.2 User Role Matrix](#122-user-role-matrix)
    - [1.2.3 Feature Comparison](#123-feature-comparison)
  - [1.3 Non-Functional Requirements](#13-non-functional-requirements)
    - [1.3.1 Performance Benchmarks](#131-performance-benchmarks)
    - [1.3.2 Scalability](#132-scalability)
    - [1.3.3 Browser Compatibility](#133-browser-compatibility)
- [2. System Architecture & Technology Stack](#2-system-architecture--technology-stack)
  - [2.1 High-Level Architecture](#21-high-level-architecture)
    - [2.1.1 Monolithic Layered Architecture](#211-monolithic-layered-architecture)
    - [2.1.2 Client-Server Communication](#212-client-server-communication)
    - [2.1.3 Three-Tier Architecture Diagram](#213-three-tier-architecture-diagram)
  - [2.2 Technology Stack Selection](#22-technology-stack-selection)
    - [2.2.1 Backend Stack: Node.js 20 LTS with Express.js 4.x](#221-backend-stack-nodejs-20-lts-with-expressjs-4x)
    - [2.2.2 Frontend Stack: React 18 with Functional Components and Hooks](#222-frontend-stack-react-18-with-functional-components-and-hooks)
    - [2.2.3 Database Selection: MongoDB vs. PostgreSQL](#223-database-selection-mongodb-vs-postgresql)
    - [2.2.4 Supporting Libraries](#224-supporting-libraries)
  - [2.3 Project Structure](#23-project-structure)
    - [2.3.1 Monorepo Organization](#231-monorepo-organization)
    - [2.3.2 Backend Directory Structure](#232-backend-directory-structure)
    - [2.3.3 Frontend Directory Structure](#233-frontend-directory-structure)
  - [2.4 Development Environment Setup](#24-development-environment-setup)
    - [2.4.1 Prerequisites](#241-prerequisites)
    - [2.4.2 Environment Variables Template](#242-environment-variables-template)
    - [2.4.3 Development Workflow](#243-development-workflow)
- [3. Database Design & Schema](#3-database-design--schema)
  - [3.1 Database Configuration](#31-database-configuration)
    - [3.1.1 MongoDB Connection Setup](#311-mongodb-connection-setup)
    - [3.1.2 Database Seeding Strategy](#312-database-seeding-strategy)
    - [3.1.3 Migration Strategy](#313-migration-strategy)
  - [3.2 Core Entity Schema Definitions](#32-core-entity-schema-definitions)
    - [3.2.1 User Schema](#321-user-schema)
    - [3.2.2 Student Schema](#322-student-schema)
    - [3.2.3 Teacher and Guardian Schemas](#323-teacher-and-guardian-schemas)
  - [3.3 Academic Entity Schemas](#33-academic-entity-schemas)
    - [3.3.1 Class Schema](#331-class-schema)
    - [3.3.2 Subject and Timetable Schemas](#332-subject-and-timetable-schemas)
  - [3.4 Transactional and Auxiliary Schemas](#34-transactional-and-auxiliary-schemas)
    - [3.4.1 Attendance Schema](#341-attendance-schema)
    - [3.4.2 Examination Schemas](#342-examination-schemas)
    - [3.4.3 Fee Schema](#343-fee-schema)
    - [3.4.4 Library Schemas](#344-library-schemas)
  - [3.5 Schema Relationships and Indexing](#35-schema-relationships-and-indexing)
    - [3.5.1 Referencing vs. Embedding Decision Matrix](#351-referencing-vs-embedding-decision-matrix)
    - [3.5.2 Critical Indexes and Entity Relationships](#352-critical-indexes-and-entity-relationships)
    - [3.5.3 Cascade Delete and Data Integrity](#353-cascade-delete-and-data-integrity)
- [4. Backend Architecture & API Design](#4-backend-architecture--api-design)
  - [4.1 Node.js Application Architecture](#41-nodejs-application-architecture)
    - [4.1.1 Express.js Bootstrap](#411-expressjs-bootstrap)
    - [4.1.2 Middleware Pipeline](#412-middleware-pipeline)
    - [4.1.3 Centralized Error Handling](#413-centralized-error-handling)
    - [4.1.4 Async Handler Wrapper](#414-async-handler-wrapper)
  - [4.2 Modular Routing Structure](#42-modular-routing-structure)
    - [4.2.1 Route Aggregation](#421-route-aggregation)
    - [4.2.2 Controller-Service-Repository Pattern](#422-controller-service-repository-pattern)
    - [4.2.3 Route Protection](#423-route-protection)
  - [4.3 RESTful API Endpoint Design](#43-restful-api-endpoint-design)
    - [4.3.1 Resource Naming Conventions](#431-resource-naming-conventions)
    - [4.3.2 API Endpoint Reference](#432-api-endpoint-reference)
    - [4.3.3 Teacher Endpoints](#433-teacher-endpoints)
    - [4.3.4 Academic Endpoints](#434-academic-endpoints)
    - [4.3.5 Attendance Endpoints](#435-attendance-endpoints)
    - [4.3.6 Fee Endpoints](#436-fee-endpoints)
    - [4.3.7 Auxiliary Module Endpoints](#437-auxiliary-module-endpoints)
  - [4.4 Request Validation & Sanitization](#44-request-validation--sanitization)
    - [4.4.1 Joi Validation Schemas](#441-joi-validation-schemas)
  - [4.5 Response Standardization](#45-response-standardization)
  - [4.6 WebSocket Integration](#46-websocket-integration)
- [5. Frontend Architecture — React](#5-frontend-architecture--react)
  - [5.1 React Application Structure](#51-react-application-structure)
    - [5.1.1 Vite Project Setup](#511-vite-project-setup)
    - [5.1.2 Atomic Design Methodology](#512-atomic-design-methodology)
    - [5.1.3 Feature-Based Folder Structure](#513-feature-based-folder-structure)
  - [5.2 Routing and Navigation](#52-routing-and-navigation)
    - [5.2.1 React Router v6](#521-react-router-v6)
    - [5.2.2 Role-Based Route Guards](#522-role-based-route-guards)
    - [5.2.3 Dynamic Navigation](#523-dynamic-navigation)
    - [5.2.4 Code Splitting](#524-code-splitting)
  - [5.3 State Management](#53-state-management)
    - [5.3.1 AuthContext](#531-authcontext)
    - [5.3.2 useReducer for Complex State](#532-usereducer-for-complex-state)
    - [5.3.3 Custom Hooks](#533-custom-hooks)
    - [5.3.4 Form Handling](#534-form-handling)
  - [5.4 Reusable Component Library](#54-reusable-component-library)
    - [5.4.1 Layout Components](#541-layout-components)
    - [5.4.2 Data Display Components](#542-data-display-components)
    - [5.4.3 Form Components](#543-form-components)
    - [5.4.4 Feedback Components](#544-feedback-components)
  - [5.5 API Integration Layer](#55-api-integration-layer)
    - [5.5.1 Axios Instance Configuration](#551-axios-instance-configuration)
    - [5.5.2 Automatic Token Refresh](#552-automatic-token-refresh)
    - [5.5.3 Service Modules](#553-service-modules)
    - [5.5.4 Error Handling](#554-error-handling)
  - [5.6 UI/UX Implementation](#56-uiux-implementation)
    - [5.6.1 Tailwind CSS Integration](#561-tailwind-css-integration)
    - [5.6.2 Responsive Design](#562-responsive-design)
    - [5.6.3 Theme System](#563-theme-system)
    - [5.6.4 State Patterns](#564-state-patterns)
- [6. Authentication & Authorization](#6-authentication--authorization)
  - [6.1 Authentication System Design](#61-authentication-system-design)
    - [6.1.1 Authentication Flow](#611-authentication-flow)
    - [6.1.2 Password Hashing](#612-password-hashing)
    - [6.1.3 JWT Token Strategy](#613-jwt-token-strategy)
    - [6.1.4 Token Blacklisting](#614-token-blacklisting)
  - [6.2 Role-Based Access Control (RBAC)](#62-role-based-access-control-rbac)
    - [6.2.1 Role Hierarchy](#621-role-hierarchy)
    - [6.2.2 Permission Matrix](#622-permission-matrix)
    - [6.2.3 Backend Authorization Middleware](#623-backend-authorization-middleware)
    - [6.2.4 Frontend Route Guards](#624-frontend-route-guards)
  - [6.3 Session Management](#63-session-management)
    - [6.3.1 Token Storage Strategy](#631-token-storage-strategy)
    - [6.3.2 Automatic Token Refresh](#632-automatic-token-refresh)
    - [6.3.3 Session Timeout](#633-session-timeout)
    - [6.3.4 Concurrent Session Handling](#634-concurrent-session-handling)
  - [6.4 Password Recovery & Account Security](#64-password-recovery--account-security)
    - [6.4.1 Forgot Password](#641-forgot-password)
    - [6.4.2 Reset Password](#642-reset-password)
    - [6.4.3 Password Policy](#643-password-policy)
- [7. Student & Teacher Management Modules](#7-student--teacher-management-modules)
  - [7.1 Student Management Module](#71-student-management-module)
    - [7.1.1 Student Registration Flow](#711-student-registration-flow)
    - [7.1.2 Student Profile](#712-student-profile)
    - [7.1.3 Class Assignment](#713-class-assignment)
    - [7.1.4 Student Search and Filter](#714-student-search-and-filter)
    - [7.1.5 Bulk Import](#715-bulk-import)
    - [7.1.6 Student Dashboard](#716-student-dashboard)
    - [7.1.7 Parent Portal](#717-parent-portal)
  - [7.2 Teacher Management Module](#72-teacher-management-module)
    - [7.2.1 Teacher Onboarding](#721-teacher-onboarding)
    - [7.2.2 Teacher Profile](#722-teacher-profile)
    - [7.2.3 Department Management](#723-department-management)
    - [7.2.4 Teacher-Class-Subject Assignment Matrix](#724-teacher-class-subject-assignment-matrix)
    - [7.2.5 Workload Calculation](#725-workload-calculation)
  - [7.3 Staff Management Module](#73-staff-management-module)
    - [7.3.1 Staff Categories](#731-staff-categories)
    - [7.3.2 Staff Registration](#732-staff-registration)
    - [7.3.3 Employment Lifecycle](#733-employment-lifecycle)
  - [7.4 User Directory & Search](#74-user-directory--search)
    - [7.4.1 Unified Directory](#741-unified-directory)
    - [7.4.2 Advanced Filters](#742-advanced-filters)
    - [7.4.3 Profile Export](#743-profile-export)
- [8. Academic Management](#8-academic-management)
  - [8.1 Academic Year & Session Management](#81-academic-year--session-management)
  - [8.2 Class & Section Management](#82-class--section-management)
    - [8.2.1 Class Hierarchy and Section Capacity](#821-class-hierarchy-and-section-capacity)
    - [8.2.2 Section CRUD API](#822-section-crud-api)
    - [8.2.3 Student Allocation and Class Teacher Assignment](#823-student-allocation-and-class-teacher-assignment)
  - [8.3 Subject Management](#83-subject-management)
    - [8.3.1 Subject Catalog](#831-subject-catalog)
    - [8.3.2 Class-Wise Subject Allocation](#832-class-wise-subject-allocation)
    - [8.3.3 Elective Selection](#833-elective-selection)
  - [8.4 Timetable Management](#84-timetable-management)
    - [8.4.1 Period Configuration](#841-period-configuration)
    - [8.4.2 Timetable Generation Algorithm](#842-timetable-generation-algorithm)
    - [8.4.3 Conflict Detection and Timetable Views](#843-conflict-detection-and-timetable-views)
    - [8.4.4 Substitution Management](#844-substitution-management)
  - [8.5 Curriculum & Syllabus Tracking](#85-curriculum--syllabus-tracking)
    - [8.5.1 Syllabus Upload and Lesson Planning](#851-syllabus-upload-and-lesson-planning)
    - [8.5.2 Progress Tracking](#852-progress-tracking)
- [9. Attendance & Examination System](#9-attendance--examination-system)
  - [9.1 Attendance Management](#91-attendance-management)
    - [9.1.1 Marking Interface](#911-marking-interface)
    - [9.1.2 Attendance Bulk Mark API](#912-attendance-bulk-mark-api)
    - [9.1.3 Status Definitions](#913-status-definitions)
    - [9.1.4 Attendance Analytics](#914-attendance-analytics)
    - [9.1.5 Monthly Report](#915-monthly-report)
    - [9.1.6 Parent Notification](#916-parent-notification)
    - [9.1.7 Leave Application](#917-leave-application)
  - [9.2 Examination Management](#92-examination-management)
    - [9.2.1 Exam Types](#921-exam-types)
    - [9.2.2 Exam Schedule](#922-exam-schedule)
    - [9.2.3 Exam Timetable](#923-exam-timetable)
    - [9.2.4 Hall Ticket](#924-hall-ticket)
  - [9.3 Marks Entry & Processing](#93-marks-entry--processing)
    - [9.3.1 Marks Entry Interface](#931-marks-entry-interface)
    - [9.3.2 Validation Rules](#932-validation-rules)
    - [9.3.3 Marks Workflow](#933-marks-workflow)
    - [9.3.4 Lock Mechanism](#934-lock-mechanism)
  - [9.4 Grading System](#94-grading-system)
    - [9.4.1 Grade Scale](#941-grade-scale)
    - [9.4.2 Grade Calculation](#942-grade-calculation)
    - [9.4.3 Result Processing](#943-result-processing)
    - [9.4.4 Report Card Generation](#944-report-card-generation)
  - [9.5 Result Publication & Analysis](#95-result-publication--analysis)
    - [9.5.1 Publication Workflow](#951-publication-workflow)
    - [9.5.2 Student Result View](#952-student-result-view)
    - [9.5.3 Class Analytics](#953-class-analytics)
    - [9.5.4 Performance Insights](#954-performance-insights)
- [10. Fee & Finance Management](#10-fee--finance-management)
  - [10.1 Fee Structure Configuration](#101-fee-structure-configuration)
    - [10.1.1 Fee Head Management](#1011-fee-head-management)
    - [10.1.2 Fee Structure Assignment](#1012-fee-structure-assignment)
    - [10.1.3 Concessions and Scholarships](#1013-concessions-and-scholarships)
    - [10.1.4 Fine Rules](#1014-fine-rules)
  - [10.2 Fee Collection Workflow](#102-fee-collection-workflow)
    - [10.2.1 Student Fee Ledger](#1021-student-fee-ledger)
    - [10.2.2 Payment Recording](#1022-payment-recording)
    - [10.2.3 Receipt Generation](#1023-receipt-generation)
    - [10.2.4 Payment Status Tracking](#1024-payment-status-tracking)
  - [10.3 Financial Reporting](#103-financial-reporting)
    - [10.3.1 Daily Collection Report](#1031-daily-collection-report)
    - [10.3.2 Monthly and Annual Analytics](#1032-monthly-and-annual-analytics)
    - [10.3.3 Outstanding Dues Analysis](#1033-outstanding-dues-analysis)
    - [10.3.4 Automated Reminders](#1034-automated-reminders)
  - [10.4 Expense & Budget Tracking](#104-expense--budget-tracking)
    - [10.4.1 Expense Management](#1041-expense-management)
    - [10.4.2 Income Summary](#1042-income-summary)
    - [10.4.3 Budgeting](#1043-budgeting)
- [11. Library, Transport & Hostel Management](#11-library-transport--hostel-management)
  - [11.1 Library Management Module](#111-library-management-module)
    - [11.1.1 Book Catalog](#1111-book-catalog)
    - [11.1.2 Book Operations](#1112-book-operations)
    - [11.1.3 Book Issue Workflow](#1113-book-issue-workflow)
    - [11.1.4 Return Processing](#1114-return-processing)
    - [11.1.5 Reservation and Renewal](#1115-reservation-and-renewal)
    - [11.1.6 Library Reports](#1116-library-reports)
  - [11.2 Transport Management Module](#112-transport-management-module)
    - [11.2.1 Vehicle Fleet](#1121-vehicle-fleet)
    - [11.2.2 Route Management](#1122-route-management)
    - [11.2.3 Student Transport Allocation](#1123-student-transport-allocation)
    - [11.2.4 Transport Fee](#1124-transport-fee)
    - [11.2.5 Vehicle Maintenance](#1125-vehicle-maintenance)
    - [11.2.6 Transport Attendance](#1126-transport-attendance)
  - [11.3 Hostel Management Module](#113-hostel-management-module)
    - [11.3.1 Room Inventory](#1131-room-inventory)
    - [11.3.2 Room Allocation](#1132-room-allocation)
    - [11.3.3 Warden Management](#1133-warden-management)
    - [11.3.4 Hostel Fee](#1134-hostel-fee)
    - [11.3.5 Visitor Log](#1135-visitor-log)
    - [11.3.6 Hostel Operations](#1136-hostel-operations)
- [12. Communication, Reports & Analytics](#12-communication-reports--analytics)
  - [12.1 Internal Communication System](#121-internal-communication-system)
    - [12.1.1 Announcements](#1211-announcements)
    - [12.1.2 Notice Board](#1212-notice-board)
    - [12.1.3 Messaging](#1213-messaging)
    - [12.1.4 Parent-Teacher Meetings](#1214-parent-teacher-meetings)
  - [12.2 Notification System](#122-notification-system)
    - [12.2.1 Multi-Channel Architecture](#1221-multi-channel-architecture)
    - [12.2.2 Email Integration](#1222-email-integration)
    - [12.2.3 SMS Gateway](#1223-sms-gateway)
    - [12.2.4 Notification Templates](#1224-notification-templates)
    - [12.2.5 Trigger-Based Notifications](#1225-trigger-based-notifications)
    - [12.2.6 Real-Time Delivery](#1226-real-time-delivery)
  - [12.3 Report Generation Engine](#123-report-generation-engine)
    - [12.3.1 Template System](#1231-template-system)
    - [12.3.2 ID Card Generation](#1232-id-card-generation)
    - [12.3.3 Certificates](#1233-certificates)
    - [12.3.4 Export Formats](#1234-export-formats)
  - [12.4 Analytics Dashboard](#124-analytics-dashboard)
    - [12.4.1 Dashboard Layout](#1241-dashboard-layout)
    - [12.4.2 Student Analytics](#1242-student-analytics)
    - [12.4.3 Fee Analytics](#1243-fee-analytics)
    - [12.4.4 Academic Analytics](#1244-academic-analytics)
    - [12.4.5 Drill-Down Capabilities](#1245-drill-down-capabilities)
- [13. Security Implementation & Deployment](#13-security-implementation--deployment)
  - [13.1 Application Security](#131-application-security)
    - [13.1.1 OWASP Mitigation Checklist](#1311-owasp-mitigation-checklist)
    - [13.1.2 Helmet.js Configuration](#1312-helmetjs-configuration)
    - [13.1.3 Rate Limiting](#1313-rate-limiting)
    - [13.1.4 CORS Policy](#1314-cors-policy)
    - [13.1.5 File Upload Security](#1315-file-upload-security)
  - [13.2 Data Security & Compliance](#132-data-security--compliance)
    - [13.2.1 Encryption at Rest](#1321-encryption-at-rest)
    - [13.2.2 TLS/SSL](#1322-tlsssl)
    - [13.2.3 Backup Strategy](#1323-backup-strategy)
    - [13.2.4 Data Privacy](#1324-data-privacy)
  - [13.3 Logging & Monitoring](#133-logging--monitoring)
    - [13.3.1 Application Logging](#1331-application-logging)
    - [13.3.2 Audit Logging](#1332-audit-logging)
    - [13.3.3 API Monitoring](#1333-api-monitoring)
    - [13.3.4 Health Checks](#1334-health-checks)
  - [13.4 Containerization & CI/CD](#134-containerization--cicd)
    - [13.4.1 Docker Configuration](#1341-docker-configuration)
    - [13.4.2 Docker Compose](#1342-docker-compose)
    - [13.4.3 CI/CD Pipeline](#1343-cicd-pipeline)
    - [13.4.4 Testing Stages](#1344-testing-stages)
    - [13.4.5 Environment Management](#1345-environment-management)
  - [13.5 Production Deployment](#135-production-deployment)
    - [13.5.1 Cloud Deployment](#1351-cloud-deployment)
    - [13.5.2 Nginx Reverse Proxy](#1352-nginx-reverse-proxy)
    - [13.5.3 Process Management](#1353-process-management)
    - [13.5.4 Post-Deployment](#1354-post-deployment)
- [Appendix: Quick Reference](#appendix-quick-reference)
  - [A.1 Technology Stack Summary](#a1-technology-stack-summary)
  - [A.2 Module Coverage Summary](#a2-module-coverage-summary)
  - [A.3 Document Files Reference](#a3-document-files-reference)
...
| Reverse Proxy | Nginx | latest | SSL termination, static serving |

## A.2 Module Coverage Summary

| Module | Chapter | Key Features |
|--------|---------|-------------|
| Student Management | 7 | Admissions, profiles, bulk import, parent portal |
| Teacher Management | 7 | Onboarding, workload, department hierarchy |
| Academic Management | 8 | Classes, subjects, timetable generation |
| Attendance | 9 | Daily marking, analytics, parent notifications |
| Examination | 9 | Exams, marks entry, grading, report cards |
| Fee Management | 10 | Fee structure, collection, receipts, reporting |
| Library | 11 | Catalog, issue/return, fines, reservations |
| Transport | 11 | Routes, vehicles, student allocation |
| Hostel | 11 | Rooms, allocation, visitor log |
| Communication | 12 | Announcements, messaging, notifications |
| Reports & Analytics | 12 | Dashboards, PDF/Excel export, charts |
| Security | 13 | OWASP mitigation, encryption, compliance |
| Deployment | 13 | Docker, CI/CD, Nginx, PM2, cloud hosting |

## A.3 Document Files Reference

| File | Description |
|------|-------------|
| `sms.agent.outline.md` | Full document outline with H2-H4 structure |
| `sms_requirements.md` | Comprehensive requirements analysis (17 domains) |
| `sms_structure.md` | Chapter hierarchy and allocation plan |
| `sms_sec01.md` – `sms_sec13.md` | Individual chapter files |
